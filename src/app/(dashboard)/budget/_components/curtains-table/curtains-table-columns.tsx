...
export const getColumns = ({ hideActions }: GetColumnsOptions = {}): ColumnDef<Curtain>[] => {
    const columns: ColumnDef<Curtain>[] = [
        ...
        },
        {
            ...
            cell: ({ row }) => <div className="text-center">{row.getValue("pinches") || "N/A"}</div>,
        },
        {
            accessorKey: "panels",
            header: () => <div className="text-center">Paneles</div>,
            cell: ({ row }) => <div className="text-center">{row.getValue("panels") || "N/A"}</div>,
        },
        {
            accessorKey: "price",
